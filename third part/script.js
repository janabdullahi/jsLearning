...
console.log(document.querySelector(".paragraph").textContent = 'Try To Find The Correct Number between 1 and 20');
...
document.querySelector(".click").addEventListener('click', function () {
    ...
    if (!guess) {
        ...
        if (score > 0) {
            console.log(document.querySelector(".paragraph").textContent = ' Too High the number is between 1 and 20')
            score--;
        ...
        if (score > 0) {
            console.log(document.querySelector(".paragraph").textContent = ' Too Low the number is between 1 and 20')
            score--;
            document.querySelector(".score").textContent = "Score : " + score
        }
        else {
